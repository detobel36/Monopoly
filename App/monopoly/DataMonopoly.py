...
DataMonopoly("MONOPOLY_70", "Monopoly édition 70è anniversaire", [
    ...
    Case("Impôts sur le revenu", 4, "firebrick4"), # False
    Case("Aéroport de Bruxelles Zaventem", 5, "lavender"),
    ...
    Case("Luchthaven Antwerpen", 35, "lavender"),
    CaseChance(36),
    Case("Antwerpen Meir", 37, "dark slate blue"),
    Case("Taxe de Luxe", 38, "firebrick4"), # False
...
DataMonopoly("MERVEILLES_MONDE", "Monopoly Merveilles du monde", [
    ...
    Case("Assurance Voyage", 4, "firebrick4", 200, False),
    ...
    Case("Taxe de Luxe", 38, "firebrick4", 100, False),
...
DataMonopoly("MONDE_2006", "Monopoly Coupe du monde 2006", [
    ...
    Case("Carton Rouge", 4, "firebrick4", 200, False),
    ...
    Case("Carton jaune", 38, "firebrick4", 100, False),
...
DataMonopoly("STAR_WARS_2", "Monopoly Star Wars (ep 2)", [
    ...
    Case("Dégat d'astéroïde", 4, "firebrick4", 200, False),
    ...
    Case("Homme des sables", 38, "firebrick4", 100, False),
