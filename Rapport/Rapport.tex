...
\section{Modélisation}
  ...
  \subsection{Cases \textit{chance}}
    Les cases chances peuvent faire gagner de l'argent mais également 
    déplacer les pions présent sur le plateau de jeu.  C'est évidemment 
    ce second comportement qui sera étudier ici.  Le Monopoly comporte 
    16 cartes chances ayant la répartition suivante:
    \begin{itemize}
  ...
  \subsection{Cases \textit{caisse de communauté}}
    Les cartes \textit{caisse de communauté} sont plus axés sur l'aspect 
    financier du jeu. Cependant 3 cartes provoques également des déplacements 
    des pions:
    \begin{itemize}
     \item se rendre à la case départ;
     \item aller en prison;
    ...
    \end{itemize}
    La modélisation des cartes \textit{caisse de communauté} se fait de la 
    même manière que les cartes \textit{chance}.
