...
\newcommand{\caseUp}{\hfill\textcolor[HTML]{008000}{$\mathbf{\uparrow}$}}
\newcommand{\caseStable}{\hfill\textcolor[HTML]{3779dd}{\textbf{-}}}
\newcommand{\caseDown}{\hfill\textcolor[HTML]{dd3737}{$\mathbf{\downarrow}$}}
...
% - Conclusion
%--------------------------------
% - Pour les résultats: 2 sous points: résultat par rapport au Monopoly, résultat par rapport à l'économie
% - Pour l'économie, intéressant après 20 tours, 50, 100, ...
% - Pour la conclusion: uniquement pour la forme.  Résumer le rapport mais également exprimer des idées pour la suite.
...
\section{Résultats}
  ...
  faciliter la lecture, les couleurs du Monopoly ``Monopoly édition 70\up{ème} 
  ...
  \subsection{Répartition des cases}
    ...
    \subsection{État stationnaire}
      Le but premier de cet article était de déterminer les cases ayant
      la plus grande probabilité d'être visité.  Pour pouvoir répondre à 
      ...
      considérer plus cas, car comme expliqué au point \ref{case_prison}, le
      joueur peut décider de payer directement pour sortir de prison ou bien
      essayer de faire un double.  On va donc à chaque fois considérer ces
      deux cas.  Le tableau \ref{result_paye} nous montre le résultat si le 
      joueur décide de payer directement alors que le tableau \ref{result_paye_pas}
      montre la répartition des cases si le joueur décide de ne payer que s'il
      n'a pas réussi à faire un double.
	...
	\label{result_paye}
      \end{table}
      On remarque logiquement que dans le tableau \ref{result_paye}, les cases \textit{prison}
      du 2\up{ème} et 3\up{ème} tour sont à zéro.  Au profit de la 25\up{ème} case qui as 
      encore plus de chance d'être visité.\\
      
    Les valeurs présentes dans les tableaux \ref{result_paye} et \ref{result_paye_pas} montrent
    la probabilité de tomber sur une case dans une situation stationnaire.  Les tableaux 
    \ref{result_tour_paye_pas} et \ref{result_tour_paye} montrent la répartition des 
    cases après un nombre définit de tour.  Après 20 lancés de dés, on est sur que tous 
    les joueurs ont fait le tour du plateau (vu que le score minimum pouvant être fait est de 2).
    Pour avoir des résultats cohérent, on a donc regardé l'évolution de la répartition
    après 20, 40 et 60 tours.  Si l'on classe les cases de la plus grande à la plus petite
    probabilité, on remarque que l'ordre des cases après 60 tours est identique à l'ordre
	...
	\cellcolor[HTML]{FF4500} 25 & 3.131 \% & \cellcolor[HTML]{000000} \textcolor{white}{41} & 3.517 \% \caseUp & \cellcolor[HTML]{000000} \textcolor{white}{41} & 3.47 \% \caseStable \\ \hline
	\cellcolor[HTML]{FF8C00} 19 & 3.086 \% & \cellcolor[HTML]{000000} \textcolor{white}{42} & 2.926 \% \caseUp & \cellcolor[HTML]{000000} \textcolor{white}{42} & 2.893 \% \caseStable \\ \hline
	\cellcolor[HTML]{FF8C00} 20 & 3.075 \% & \cellcolor[HTML]{FF4500} 25 & 2.762 \% \caseUp & \cellcolor[HTML]{FF4500} 25 & 2.793 \% \caseStable \\ \hline
	\cellcolor[HTML]{FFFFFF} 21 & 3.068 \% & \cellcolor[HTML]{FFFFFF} 1  & 2.746 \% \caseUp & \cellcolor[HTML]{FFFFFF} 1 & 2.707 \% \caseStable \\ \hline
	\cellcolor[HTML]{000000} \textcolor{white}{41} & 3.011 \% & \cellcolor[HTML]{E6E6FA} 16 & 2.6 \% \caseUp & \cellcolor[HTML]{FF8C00} 19 & 2.637 \% \caseUp \\ \hline
	\cellcolor[HTML]{FFC1C1} 23 & 3.0 \% & \cellcolor[HTML]{FF8C00} 19 & 2.592 \% \caseDown & \cellcolor[HTML]{E6E6FA} 16 & 2.634 \% \caseDown \\ \hline
	\cellcolor[HTML]{E6E6FA} 16 & 2.967 \% & \cellcolor[HTML]{FFFFFF} 21 & 2.572 \% \caseDown & \cellcolor[HTML]{FFFFFF} 21 & 2.616 \% \caseStable \\ \hline
	\cellcolor[HTML]{EEEED1} 18 & 2.896 \% & \cellcolor[HTML]{FF8C00} 20 & 2.562 \% \caseDown & \cellcolor[HTML]{FF8C00} 20 & 2.607 \% \caseStable \\ \hline
	\cellcolor[HTML]{FF8C00} 17 & 2.891 \% & \cellcolor[HTML]{FFC1C1} 23 & 2.554 \% \caseDown & \cellcolor[HTML]{FFC1C1} 23 & 2.593 \% \caseStable \\ \hline
	\cellcolor[HTML]{FF4500} 22 & 2.87 \% & \cellcolor[HTML]{FF8C00} 17 & 2.467 \% \caseDown & \cellcolor[HTML]{FF8C00} 17 & 2.506 \% \caseStable \\ \hline
	\cellcolor[HTML]{FF4500} 24 & 2.763 \% & \cellcolor[HTML]{EEEED1} 18 & 2.409 \% \caseDown & \cellcolor[HTML]{EEEED1} 18 & 2.453 \% \caseStable \\ \hline
	\cellcolor[HTML]{E6E6FA} 26 & 2.688 \% & \cellcolor[HTML]{000000} \textcolor{white}{43} & 2.401 \% \caseUp & \cellcolor[HTML]{FF4500} 22 & 2.426 \% \caseUp \\ \hline
	\cellcolor[HTML]{FFD700} 27 & 2.636 \% & \cellcolor[HTML]{FF4500} 22 & 2.384 \% \caseDown & \cellcolor[HTML]{000000} \textcolor{white}{43} & 2.414 \% \caseDown \\ \hline
	\cellcolor[HTML]{FFD700} 28 & 2.559 \% & \cellcolor[HTML]{EEEED1} 34 & 2.377 \% \caseUp & \cellcolor[HTML]{FFD700} 27 & 2.395 \% \caseUp \\ \hline
	\cellcolor[HTML]{FF69B4} 15 & 2.539 \% & \cellcolor[HTML]{FFD700} 27 & 2.374 \% \caseDown & \cellcolor[HTML]{E6E6FA} 26 & 2.391 \% \caseUp \\ \hline
	\cellcolor[HTML]{000000} \textcolor{white}{42} & 2.537 \% & \cellcolor[HTML]{FF69B4} 12 & 2.373 \% \caseUp & \cellcolor[HTML]{FF4500} 24 & 2.385 \% \caseUp \\ \hline
	\cellcolor[HTML]{000000} \textcolor{white}{43} & 2.512 \% & \cellcolor[HTML]{2E8B57} 32 & 2.371 \% \caseUp & \cellcolor[HTML]{FF69B4} 12 & 2.382 \% \caseDown \\ \hline
	\cellcolor[HTML]{FFFFF0} 29 & 2.456 \% & \cellcolor[HTML]{FFD700} 28 & 2.364 \% \caseDown & \cellcolor[HTML]{FFD700} 28 & 2.38 \% \caseStable \\ \hline
	\cellcolor[HTML]{FF69B4} 12 & 2.449 \% & \cellcolor[HTML]{E6E6FA} 26 & 2.364 \% \caseDown & \cellcolor[HTML]{2E8B57} 32 & 2.359 \% \caseDown \\ \hline
	\cellcolor[HTML]{FFD700} 30 & 2.358 \% & \cellcolor[HTML]{BEBEBE} 31 & 2.35 \% \caseUp & \cellcolor[HTML]{EEEED1} 34 & 2.352 \% \caseDown \\ \hline
	\cellcolor[HTML]{FFFFFF} 1 & 2.323 \% & \cellcolor[HTML]{FF4500} 24 & 2.349 \% \caseDown & \cellcolor[HTML]{FFFFF0} 29 & 2.346 \% \caseUp \\ \hline
	\cellcolor[HTML]{BEBEBE} 31 & 2.311 \% & \cellcolor[HTML]{483D8B} \textcolor{white}{40} & 2.339 \% \caseUp & \cellcolor[HTML]{BEBEBE} 31 & 2.345 \% \caseDown \\ \hline
	\cellcolor[HTML]{FFFFF0} 13 & 2.301 \% & \cellcolor[HTML]{FFFFF0} 29 & 2.338 \% \caseDown & \cellcolor[HTML]{FFD700} 30 & 2.32 \% \caseUp \\ \hline
	\cellcolor[HTML]{2E8B57} 32 & 2.254 \% & \cellcolor[HTML]{A0522D} 2 & 2.332 \% \caseUp & \cellcolor[HTML]{483D8B} \textcolor{white}{40} & 2.302 \% \caseDown \\ \hline
	\cellcolor[HTML]{FF69B4} 14 & 2.242 \% & \cellcolor[HTML]{FFD700} 30 & 2.318 \% \caseDown & \cellcolor[HTML]{A0522D} 2 & 2.295 \% \caseDown \\ \hline
	\cellcolor[HTML]{2E8B57} 33 & 2.132 \% & \cellcolor[HTML]{2E8B57} 33 & 2.309 \% \caseStable & \cellcolor[HTML]{2E8B57} 33 & 2.291 \% \caseStable \\ \hline
	\cellcolor[HTML]{EEEED1} 34 & 2.118 \% & \cellcolor[HTML]{FF69B4} 15 & 2.248 \% \caseDown & \cellcolor[HTML]{FF69B4} 15 & 2.276 \% \caseStable \\ \hline
	\cellcolor[HTML]{000000} \textcolor{white}{11} & 2.013 \% & \cellcolor[HTML]{2E8B57} 35 & 2.196 \% \caseUp & \cellcolor[HTML]{2E8B57} 35 & 2.169 \% \caseStable \\ \hline
	\cellcolor[HTML]{1E90FF} 10 & 1.989 \% & \cellcolor[HTML]{FFFFF0} 13 & 2.153 \% \caseDown & \cellcolor[HTML]{FFFFF0} 13 & 2.168 \% \caseStable \\ \hline
	\cellcolor[HTML]{1E90FF} 9 & 1.977 \% & \cellcolor[HTML]{E6E6FA} 36 & 2.126 \% \caseUp & \cellcolor[HTML]{E6E6FA} 36 & 2.096 \% \caseStable \\ \hline
	\cellcolor[HTML]{483D8B} \textcolor{white}{40} & 1.929 \% & \cellcolor[HTML]{8B1A1A} \textcolor{white}{5} & 2.12 \% \caseUp & \cellcolor[HTML]{8B1A1A} \textcolor{white}{5} & 2.094 \% \caseStable \\ \hline
	\cellcolor[HTML]{FFC1C1} 8 & 1.922 \% & \cellcolor[HTML]{FFC1C1} 8 & 2.09 \% \caseStable & \cellcolor[HTML]{1E90FF} 9 & 2.078 \% \caseUp \\ \hline
	\cellcolor[HTML]{A0522D} 2 & 1.919 \% & \cellcolor[HTML]{1E90FF} 9 & 2.085 \% \caseDown & \cellcolor[HTML]{FFC1C1} 8 & 2.077 \% \caseDown \\ \hline
	\cellcolor[HTML]{2E8B57} 35 & 1.915 \% & \cellcolor[HTML]{1E90FF} 7 & 2.067 \% \caseUp & \cellcolor[HTML]{1E90FF} 7 & 2.049 \% \caseStable \\ \hline
	\cellcolor[HTML]{1E90FF} 7 & 1.842 \% & \cellcolor[HTML]{1E90FF} 10 & 2.039 \% \caseDown & \cellcolor[HTML]{1E90FF} 10 & 2.037 \% \caseStable \\ \hline
	\cellcolor[HTML]{8B1A1A} \textcolor{white}{5} & 1.819 \% & \cellcolor[HTML]{FFC1C1} 37 & 2.029 \% \caseUp & \cellcolor[HTML]{FF69B4} 14 & 2.033 \% \caseUp \\ \hline
	\cellcolor[HTML]{E6E6FA} 36 & 1.809 \% & \cellcolor[HTML]{E6E6FA} 6 & 2.019 \% \caseUp & \cellcolor[HTML]{000000} \textcolor{white}{11} & 2.003 \% \caseUp \\ \hline
	\cellcolor[HTML]{E6E6FA} 6 & 1.743 \% & \cellcolor[HTML]{FF69B4} 14 & 2.01 \% \caseDown & \cellcolor[HTML]{FFC1C1} 37 & 1.997 \% \caseDown \\ \hline
	\cellcolor[HTML]{FFC1C1} 37 & 1.684 \% & \cellcolor[HTML]{000000} \textcolor{white}{11} & 1.999 \% \caseDown & \cellcolor[HTML]{E6E6FA} 6 & 1.996 \% \caseDown \\ \hline
	\cellcolor[HTML]{A0522D} 4 & 1.614 \% & \cellcolor[HTML]{A0522D} 4 & 1.973 \% \caseStable & \cellcolor[HTML]{A0522D} 4 & 1.942 \% \caseStable \\ \hline
	\cellcolor[HTML]{483D8B} \textcolor{white}{38} & 1.561 \% & \cellcolor[HTML]{EEEED1} 3 & 1.941 \% \caseUp & \cellcolor[HTML]{EEEED1} 3 & 1.906 \% \caseStable \\ \hline
	\cellcolor[HTML]{EEEED1} 3 & 1.554 \% & \cellcolor[HTML]{8B1A1A} 39 & 1.932 \% \caseUp & \cellcolor[HTML]{8B1A1A} 39 & 1.896 \% \caseStable \\ \hline
	\cellcolor[HTML]{8B1A1A} 39 & 1.54 \% & \cellcolor[HTML]{483D8B} \textcolor{white}{38} & 1.924 \% \caseDown & \cellcolor[HTML]{483D8B} \textcolor{white}{38} & 1.89 \% \caseStable \\ \hline
      \end{tabular}
	...
	\hline
        ...
        \multicolumn{1}{c|}{{\textbf{N}}} & % Numero
        \multicolumn{1}{p{1.5cm}|}{\centering \textbf{Probabilité \\ après 60 tours}} \\ \hline %
        \cellcolor[HTML]{000000} \textcolor{white}{41} & 3.485 \% & \cellcolor[HTML]{000000} \textcolor{white}{41} & 3.675 \% \caseStable & \cellcolor[HTML]{000000} \textcolor{white}{41} & 3.675 \% \caseStable \\ \hline 
	\cellcolor[HTML]{FF4500} 25 & 3.171 \% & \cellcolor[HTML]{FF4500} 25 & 2.948 \% \caseStable & \cellcolor[HTML]{FF4500} 25 & 2.948 \% \caseStable \\ \hline 
	\cellcolor[HTML]{FF8C00} 20 & 3.035 \% & \cellcolor[HTML]{E6E6FA} 16 & 2.89 \%  \caseUp & \cellcolor[HTML]{E6E6FA} 16 & 2.89 \%  \caseStable \\ \hline 
	\cellcolor[HTML]{E6E6FA} 16 & 2.967 \% & \cellcolor[HTML]{FFFFFF}  1 & 2.872 \% \caseUp & \cellcolor[HTML]{FFFFFF}  1 & 2.872 \% \caseStable \\ \hline 
	\cellcolor[HTML]{FF8C00} 19 & 2.885 \% & \cellcolor[HTML]{FF8C00} 20 & 2.844 \% \caseDown & \cellcolor[HTML]{FF8C00} 20 & 2.844 \% \caseStable \\ \hline 
	\cellcolor[HTML]{EEEED1} 18 & 2.882 \% & \cellcolor[HTML]{EEEED1} 18 & 2.759 \% \caseStable & \cellcolor[HTML]{EEEED1} 18 & 2.759 \% \caseStable \\ \hline 
	\cellcolor[HTML]{FFFFFF} 21 & 2.856 \% & \cellcolor[HTML]{FF8C00} 19 & 2.73 \%  \caseDown & \cellcolor[HTML]{FF8C00} 19 & 2.73 \%  \caseStable \\ \hline 
	\cellcolor[HTML]{FF4500} 22 & 2.832 \% & \cellcolor[HTML]{FFFFFF} 21 & 2.651 \% \caseDown & \cellcolor[HTML]{FFFFFF} 21 & 2.651 \% \caseStable \\ \hline 
	\cellcolor[HTML]{FFC1C1} 23 & 2.809 \% & \cellcolor[HTML]{FF4500} 22 & 2.613 \% \caseDown & \cellcolor[HTML]{FF4500} 22 & 2.613 \% \caseStable \\ \hline 
	\cellcolor[HTML]{FF4500} 24 & 2.755 \% & \cellcolor[HTML]{FF8C00} 17 & 2.601 \% \caseUp & \cellcolor[HTML]{FF8C00} 17 & 2.601 \% \caseStable \\ \hline 
	\cellcolor[HTML]{E6E6FA} 26 & 2.742 \% & \cellcolor[HTML]{FFC1C1} 23 & 2.579 \% \caseDown & \cellcolor[HTML]{FFC1C1} 23 & 2.579 \% \caseStable \\ \hline 
	\cellcolor[HTML]{FFD700} 27 & 2.725 \% & \cellcolor[HTML]{FFD700} 27 & 2.531 \% \caseStable & \cellcolor[HTML]{FFD700} 27 & 2.531 \% \caseStable \\ \hline 
	\cellcolor[HTML]{FF8C00} 17 & 2.703 \% & \cellcolor[HTML]{E6E6FA} 26 & 2.53 \%  \caseDown & \cellcolor[HTML]{E6E6FA} 26 & 2.53 \%  \caseStable \\ \hline 
	\cellcolor[HTML]{FFD700} 28 & 2.681 \% & \cellcolor[HTML]{FF4500} 24 & 2.52 \%  \caseDown & \cellcolor[HTML]{FF4500} 24 & 2.52 \%  \caseStable \\ \hline 
	\cellcolor[HTML]{FFFFFF}  1 & 2.667 \% & \cellcolor[HTML]{FF69B4} 12 & 2.513 \% \caseUp & \cellcolor[HTML]{FF69B4} 12 & 2.513 \% \caseStable \\ \hline 
	\cellcolor[HTML]{FFFFF0} 29 & 2.616 \% & \cellcolor[HTML]{FFD700} 28 & 2.509 \% \caseDown & \cellcolor[HTML]{FFD700} 28 & 2.509 \% \caseStable \\ \hline 
	\cellcolor[HTML]{FFD700} 30 & 2.556 \% & \cellcolor[HTML]{EEEED1} 34 & 2.487 \% \caseUp & \cellcolor[HTML]{EEEED1} 34 & 2.487 \% \caseStable \\ \hline 
	\cellcolor[HTML]{BEBEBE} 31 & 2.552 \% & \cellcolor[HTML]{2E8B57} 32 & 2.487 \% \caseUp & \cellcolor[HTML]{2E8B57} 32 & 2.487 \% \caseStable \\ \hline 
	\cellcolor[HTML]{2E8B57} 32 & 2.537 \% & \cellcolor[HTML]{FFFFF0} 29 & 2.47 \%  \caseDown & \cellcolor[HTML]{FFFFF0} 29 & 2.47 \%  \caseStable \\ \hline 
	\cellcolor[HTML]{FF69B4} 12 & 2.479 \% & \cellcolor[HTML]{BEBEBE} 31 & 2.467 \% \caseDown & \cellcolor[HTML]{BEBEBE} 31 & 2.467 \% \caseStable \\ \hline 
	\cellcolor[HTML]{EEEED1} 34 & 2.458 \% & \cellcolor[HTML]{A0522D}  2 & 2.446 \% \caseUp & \cellcolor[HTML]{A0522D}  2 & 2.446 \% \caseStable \\ \hline 
	\cellcolor[HTML]{2E8B57} 33 & 2.436 \% & \cellcolor[HTML]{FFD700} 30 & 2.44 \%  \caseDown & \cellcolor[HTML]{FFD700} 30 & 2.44 \%  \caseStable \\ \hline 
	\cellcolor[HTML]{FF69B4} 15 & 2.357 \% & \cellcolor[HTML]{483D8B} \textcolor{white}{40} & 2.43 \% \caseUp & \cellcolor[HTML]{483D8B} \textcolor{white}{40} & 2.43 \%  \caseStable \\ \hline 
	\cellcolor[HTML]{483D8B} \textcolor{white}{40} & 2.248 \% & \cellcolor[HTML]{2E8B57} 33 & 2.418 \% \caseDown & \cellcolor[HTML]{2E8B57} 33 & 2.418 \% \caseStable \\ \hline 
	\cellcolor[HTML]{2E8B57} 35 & 2.247 \% & \cellcolor[HTML]{FF69B4} 15 & 2.306 \% \caseDown & \cellcolor[HTML]{FF69B4} 15 & 2.306 \% \caseStable \\ \hline 
	\cellcolor[HTML]{FF69B4} 14 & 2.235 \% & \cellcolor[HTML]{2E8B57} 35 & 2.294 \% \caseDown & \cellcolor[HTML]{2E8B57} 35 & 2.294 \% \caseStable \\ \hline 
	\cellcolor[HTML]{A0522D}  2 & 2.231 \% & \cellcolor[HTML]{8B1A1A} \textcolor{white}{5} & 2.223 \% \caseUp & \cellcolor[HTML]{8B1A1A}  \textcolor{white}{5} & 2.223 \% \caseStable \\ \hline 
	\cellcolor[HTML]{E6E6FA} 36 & 2.142 \% & \cellcolor[HTML]{E6E6FA} 36 & 2.219 \% \caseStable & \cellcolor[HTML]{E6E6FA} 36 & 2.219 \% \caseStable \\ \hline 
	\cellcolor[HTML]{FFFFF0} 13 & 2.134 \% & \cellcolor[HTML]{FF69B4} 14 & 2.212 \% \caseDown & \cellcolor[HTML]{FF69B4} 14 & 2.212 \% \caseStable \\ \hline 
	\cellcolor[HTML]{1E90FF}  9 & 2.075 \% & \cellcolor[HTML]{1E90FF}  9 & 2.205 \% \caseStable & \cellcolor[HTML]{1E90FF}  9 & 2.205 \% \caseStable \\ \hline 
	\cellcolor[HTML]{1E90FF} 10 & 2.058 \% & \cellcolor[HTML]{FFC1C1}  8 & 2.204 \% \caseUp & \cellcolor[HTML]{FFC1C1}  8 & 2.204 \% \caseStable \\ \hline 
	\cellcolor[HTML]{000000} \textcolor{white}{11} & 2.053 \% & \cellcolor[HTML]{1E90FF}  7 & 2.175 \% \caseUp & \cellcolor[HTML]{1E90FF} 7 & 2.175 \%  \caseStable \\ \hline 
	\cellcolor[HTML]{FFC1C1}  8 & 2.049 \% & \cellcolor[HTML]{1E90FF} 10 & 2.16 \% \caseDown & \cellcolor[HTML]{1E90FF} 10 & 2.16 \%  \caseStable \\ \hline 
	\cellcolor[HTML]{8B1A1A}  \textcolor{white}{5} & 2.025 \% & \cellcolor[HTML]{FFFFF0} 13 & 2.139 \% \caseDown & \cellcolor[HTML]{FFFFF0} 13 & 2.139 \% \caseStable \\ \hline 
	\cellcolor[HTML]{FFC1C1} 37 & 2.008 \% & \cellcolor[HTML]{000000} \textcolor{white}{11} & 2.122 \% \caseDown & \cellcolor[HTML]{000000} \textcolor{white}{11} & 2.122 \% \caseStable \\ \hline 
	\cellcolor[HTML]{1E90FF}  7 & 1.998 \% & \cellcolor[HTML]{E6E6FA}  6 & 2.119 \% \caseUp & \cellcolor[HTML]{E6E6FA}  6 & 2.119 \% \caseStable \\ \hline 
	\cellcolor[HTML]{E6E6FA}  6 & 1.926 \% & \cellcolor[HTML]{FFC1C1} 37 & 2.114 \% \caseDown & \cellcolor[HTML]{FFC1C1} 37 & 2.114 \% \caseStable \\ \hline 
	\cellcolor[HTML]{483D8B} \textcolor{white}{38} & 1.871 \% & \cellcolor[HTML]{A0522D}  4 & 2.062 \% \caseUp & \cellcolor[HTML]{A0522D}  4 & 2.062 \% \caseStable \\ \hline 
	\cellcolor[HTML]{A0522D}  4 & 1.852 \% & \cellcolor[HTML]{EEEED1}  3 & 2.025 \% \caseUp & \cellcolor[HTML]{EEEED1} 3 & 2.025 \%  \caseStable \\ \hline 
	\cellcolor[HTML]{8B1A1A} 39 & 1.85 \%  & \cellcolor[HTML]{8B1A1A} 39 & 2.01 \% \caseStable & \cellcolor[HTML]{8B1A1A} 39 & 2.01 \%  \caseStable \\ \hline 
	\cellcolor[HTML]{EEEED1}  3 & 1.813 \% & \cellcolor[HTML]{483D8B} \textcolor{white}{38} & 2.002 \% \caseDown & \cellcolor[HTML]{483D8B} \textcolor{white}{38} & 2.002 \% \caseStable \\ \hline 
	\cellcolor[HTML]{000000} \textcolor{white}{42} & 0.0 \%   & \cellcolor[HTML]{000000} \textcolor{white}{42} & 0.0 \% \caseStable & \cellcolor[HTML]{000000} \textcolor{white}{42} & 0.0 \%   \caseStable \\ \hline 
	\cellcolor[HTML]{000000} \textcolor{white}{43} & 0.0 \%   & \cellcolor[HTML]{000000} \textcolor{white}{43} & 0.0 \% \caseStable & \cellcolor[HTML]{000000} \textcolor{white}{43} & 0.0 \%   \caseStable \\ \hline
      \end{tabular}
...
\appendix
  ...
  \section{Liste des cases}
    \label{liste_case}
    Les cases \textit{prison} sont numérotée à partir de 41 (la case \textit{prison} 2\up{ème} tour sera donc numéroté 42).\\
    \rotatebox{90}{
      \centering
