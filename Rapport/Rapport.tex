...
\section{Modélisation}
  ...
  \subsection{Faire un double}
    ...
    \subsubsection{Probabilité de faire un double}
      ...
      $4$ mais seulement une chance sur 36 de faire un double et 2
      sur 36 de faire un simple 4 avec deux dés différents.
  ...
  \subsection{Case prison}
    ...
    Comme vu dans la \ref{repart_des}, il y a 36 cas possible lorsque l'on lance 
