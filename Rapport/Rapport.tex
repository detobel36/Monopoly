...
% New commands
\newcommand{\monopoly70Anni}{``Monopoly édition 70\up{ème} anniversaire''}
...
\section{Approche théorique}
  ...
  \subsection{Notation des chaînes des Markov}
    ...
    \subsubsection{Fortement connexe}
      ...
      pour chaque paire d'état $(s, t)$ telle que $s, t \in T$, il existe un
		chemin $s_0, s_1, ..., s_n$ tel que $s_i \in T$ pour $0 \leq i \leq n$,  % RMQ: Tu parles de chemin sans l'avoir défini. Voici une idée de définition : « Un tuple $(s_0, \ldots, s_n) \in T^n$ est appelé \textit{chemin} si pour tout $i \in \{0, \ldots, n-1\}$, $\mathbf P(s_i, s_{i+1}) \neq 0$. »
      $s_0 = s$ et $s_n = t$.\\
  ...
  \subsection{Distribution stationnaire}
    ...
    \subsubsection{Calcul de la distribution stationnaire}
      ...
      de son BSCC est trivial (vu qu'il n'en existe qu'un seul) et vaut 1.  % Il n'en existe qu'un quoi ? Un seul état stationnaire ? Donc la distribution est triviale et est \delta_i^{h.s.}.
      ...
      $$ \mathbf{P} =  % Peut-être la noter $\mathbf{P}' ? Parce que la notation P est déjà utilisée
	\begin{blockarray}{ccccccc}
	& vol & dec. & att. & sol & ctr. & h.s. \\
	  \begin{block}{c(cccccc)}
	    vol  & 0 & 0 & 1 & 0    & 0   & 0    \\
...
\section{Modélisation}
  ...
  \subsection{Plateau de jeux}  % Plateaux de jeux ou jeux de plateau ?
  ...
  \subsection{Modélisation}
    ...
    Markov et plus particulièrement par un BSCC.  Plus concrètement, chaque case sera  % Par un BSCC ? Hasardeux : le processus de Markov n'est pas un BSCC, il s'avère que son espace d'états est un BSCC, mais la chaîne en entier ne l'est pas.
  ...
  \subsection{Case \textit{prison}}
	...
	ce qui correspond à 6 déplacements;  % Pourquoi 6 déplacements ?
    ...
    Cette possibilité est-elle donnée uniquement avant le premier tour  % Formulation sous forme de question ?
    passé en prison, ou bien le joueur peut reconsidérer cette offre à
  ...
  \subsection{Cases \textit{chance}}
    ...
    \begin{itemize}
     ...
     \item se rendre à la 36\up{ème} case (dernière case avant l'arrivée).  % C'est la 39e la dernière avant l'arrivée
    \end{itemize}
  ...
  \subsection{Probabilité de visiter une case}
    ...
    BSCC.  On va donc utiliser la distribution stationnaire (présentée dans  % Même remarque pour le BSCC
...
\section{Résultats}
  ...
  \subsection{Répartition des cases}
	...
	\label{result_paye}
      ...
      par les joueurs sortant de prison.  Comme le case \textit{prison} a beaucoup plus de chance % Beaucoup ? M'ouais c'est plus grand mais je ne dirais pas *beaucoup*
    ...
    \subsubsection{Tour par tour}
      ...
      et un symbole permet d'indiquer si le résultat obtenu dans la colonne précédente (10 tours avant donc)  % 10 ou 20 ?
  ...
  \subsection{Rentabilité}
	...
	\hline
	\multicolumn{1}{|c|}{{\textbf{N}}} & % Numero
	\multicolumn{1}{p{1.5cm}|}{\rotatebox{90}{\textbf{\shortstack[l]{Prix d'achat\\(avec hotel)}}}} & %
	\multicolumn{1}{p{1.5cm}|}{\rotatebox{90}{\textbf{\shortstack[l]{Revenu espéré\\par tour adverse}}}} &
	\multicolumn{1}{c|}{\rotatebox{90}{\textbf{\shortstack[l]{Nombre de tour\\pour rentabiliser}}}} \\ \hline %
	\cellcolor[HTML]{A0522D} 2 & 3100000 \$ & 57 449.676 \$ & 54 \\ \hline
	\cellcolor[HTML]{A0522D} 4 & 3100000 \$ & 87 488.073 \$ & 36 \\ \hline
	\cellcolor[HTML]{1E90FF} 7 & 3500000 \$ & 112 775.793 \$ & 32 \\ \hline
	\cellcolor[HTML]{1E90FF} 9 & 3500000 \$ & 114 328.207 \$ & 31 \\ \hline
	\cellcolor[HTML]{1E90FF} 10 & 3700000 \$ & 122 205.803 \$ & 31 \\ \hline
	\cellcolor[HTML]{FF69B4} 12 & 6400000 \$ & 178 610.779 \$ & 36 \\ \hline
	\cellcolor[HTML]{FF69B4} 14 & 6400000 \$ & 152 325.798 \$ & 43 \\ \hline
	\cellcolor[HTML]{FF69B4} 15 & 6600000 \$ & 204 601.833 \$ & 33 \\ \hline
	\cellcolor[HTML]{FF8C00} 17 & 6800000 \$ & 237 736.322 \$ & 29 \\ \hline
	\cellcolor[HTML]{FF8C00} 19 & 6800000 \$ & 250 131.845 \$ & 28 \\ \hline
	\cellcolor[HTML]{FF8C00} 20 & 7000000 \$ & 260 354.264 \$ & \textbf{27} \\ \hline
	\cellcolor[HTML]{FF4500} 22 & 9700000 \$ & 254 410.886 \$ & 39 \\ \hline
	\cellcolor[HTML]{FF4500} 24 & 9700000 \$ & 250 140.482 \$ & 39 \\ \hline
	\cellcolor[HTML]{FF4500} 25 & 9900000 \$ & 306 977.189 \$ & 33 \\ \hline
	\cellcolor[HTML]{FFD700} 27 & 10100000 \$ & 275 276.298 \$ & 37 \\ \hline
	\cellcolor[HTML]{FFD700} 28 & 10100000 \$ & 273 544.421 \$ & 37 \\ \hline
	\cellcolor[HTML]{FFD700} 30 & 10300000 \$ & 278 378.326 \$ & 38 \\ \hline
	...
	\multicolumn{1}{p{1.5cm}|}{\rotatebox{90}{\textbf{\shortstack[l]{Revenu espéré\\par tour adverse}}}} &
	\multicolumn{1}{c|}{\rotatebox{90}{\textbf{\shortstack[l]{Nombre de tour\\pour rentabiliser}}}} \\ \hline %
	\cellcolor[HTML]{A0522D} 2 & 3100000 \$ & 60 979.848 \$ & 51 \\ \hline
	\cellcolor[HTML]{A0522D} 4 & 3100000 \$ & 92 451.629 \$ & 34 \\ \hline
	\cellcolor[HTML]{1E90FF} 7 & 3500000 \$ & 119 181.788 \$ & 30 \\ \hline
	\cellcolor[HTML]{1E90FF} 9 & 3500000 \$ & 120 874.543 \$ & 29 \\ \hline
	\cellcolor[HTML]{1E90FF} 10 & 3700000 \$ & 129 194.389 \$ & 29 \\ \hline
	\cellcolor[HTML]{FF69B4} 12 & 6400000 \$ & 188 115.555 \$ & 35 \\ \hline
	\cellcolor[HTML]{FF69B4} 14 & 6400000 \$ & 165 676.394 \$ & 39 \\ \hline
	\cellcolor[HTML]{FF69B4} 15 & 6600000 \$ & 207 410.610 \$ & 32 \\ \hline
	\cellcolor[HTML]{FF8C00} 17 & 6800000 \$ & 247 074.875 \$ & 28 \\ \hline
	\cellcolor[HTML]{FF8C00} 19 & 6800000 \$ & 259 565.992 \$ & 27 \\ \hline
	\cellcolor[HTML]{FF8C00} 20 & 7000000 \$ & 284 820.589 \$ & \textbf{25} \\ \hline
	\cellcolor[HTML]{FF4500} 22 & 9700000 \$ & 275 008.614 \$ & 36 \\ \hline
	\cellcolor[HTML]{FF4500} 24 & 9700000 \$ & 265 492.410 \$ & 37 \\ \hline
	\cellcolor[HTML]{FF4500} 25 & 9900000 \$ & 325 141.089 \$ & 31 \\ \hline
	\cellcolor[HTML]{FFD700} 27 & 10100000 \$ & 292 026.842 \$ & 35 \\ \hline
	\cellcolor[HTML]{FFD700} 28 & 10100000 \$ & 289 426.834 \$ & 35 \\ \hline
	\cellcolor[HTML]{FFD700} 30 & 10300000 \$ & 293 651.955 \$ & 36 \\ \hline
