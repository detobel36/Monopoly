...
\section{Introduction}
  ...
  Cet article se base donc essentiellement sur le cours: \citep{COURS}.
...
\section{Approche théorique}
  ...
  \subsection{Les chaînes de Markov}
    ...
    Nottons également que les chaînes de Markov peuvent être utilisé
    ...
    en fonction de la probabilité de passé d'un état à un autre.
    
    \subsubsection{Exemple}
      Afin d'illustrer les notions liées aux chaînes de Markov, on va se baser sur 
      les différentes états que peut avoir un avion.  On va donc ici considérer 
