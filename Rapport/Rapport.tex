...
\section{Résultats}
  ...
  \subsection{Rentabilité}
    ...
    \begin{table}
      ...
      \end{tabular}
      \caption{Revenu moyen (avec un hotel) par tour adverse lorsque le joueur ne paye pas pour sortir de prison}
    ...
    \begin{table}
      ...
      \end{tabular}
      \caption{Revenu moyen (avec un hotel) par tour adverse lorsque le joueur paye pour sortir de prison}
